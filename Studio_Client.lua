wait(5); -- Wait for the server to load fully.
...
workspace:WaitForChild "LocalClientHook".Event:connect(function()
	PluginManager():CreatePlugin():SetSetting("ClientOutput", table.concat(prints, "\n"));
