...
function StudioManager.StartServer()
	io.popen((os.getenv("LOCALAPPDATA") .. "\\Roblox\\Versions\\version-536a65c8f5284f3f\\RobloxStudioBeta.exe -testMode -fileLocation D:/Valkyrie_CI/RunFile.rbxl -script \"%s\""):format(io.open("Studio_Server.lua", "r"):read("*all"):gsub("\"", "\\\"")):gsub("&", "^&"), "r"):close();
end
